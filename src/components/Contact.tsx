...
export function Contact() {
  ...
  const contacts = [
    {
      name: "WhatsApp",
      description: "+55 (67) 9-9247-5581",
      link: "https://wa.me/5567992475581?text=Olá...",
      icon: <FaWhatsapp className="h-10 w-10" />,
    },
    {
      name: "Email",
      description: "brunofarais17@hotmail.com",
      link: "mailto:brunofarais17@hotmail.com?subject=Olá...",
      icon: <HiOutlineEnvelope className="h-10 w-10" />,
    },
    {
      name: "Campos Grande",
      description: "Nova Campo Grande",
      link: "https://goo.gl/maps/avPMiPJ2Uy6i8NtHA",

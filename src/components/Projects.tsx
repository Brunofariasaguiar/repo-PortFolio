  ...
  const projects = [
    {
      title: "Meu PortFólio",
      description:
        "Criei o portfolio para exibir meu trabalho e compartilhar minha experiência como desenvolvedor, destacando projetos e habilidades relevantes. É uma forma de mostrar meu progresso, conquistas e atrair oportunidades profissionais na área de desenvolvimento",
      image:

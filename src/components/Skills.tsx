...
export function Skills() {
  const educations = [
    {
      name: "Curso de SQL Firebird | MQFS",
    },
    {
      name: "Graduação de Banco de Dados | Estácio de Sá",
    },
    {
      name: "Curso de Desenvolvimento Web Full Stack | Dev Samurai",
    },
    {
      name: "Curso de Python | Curso em Video",
    },
    {
      name: "Curso de Desenvolvimento web Full Stack | Sujeito Programador",
    },
    {
      name: "Curso de Desenvolvimento Mobile | Sujeito Programador",
    },
  ];
  const skills = [
    {
      ...
      <div className="container mx-auto max-w-4xl p-4 py-12">
        <div className="relative mb-4 p-4 text-center">
          ...
          <p className="relative text-sm text-gray-700">
            Front-end | React.js | React Native | Node.js | TypeScript |
            JavaScript | PSQL | SQL | Java | Python | Power BI
          </p>
        ...
        <div className="flex flex-col gap-10 md:flex-row">
          ...
          <div className="basis-1/2">
            <h3 className="mb-5 flex items-center gap-2 text-lg font-extrabold text-gray-700">
